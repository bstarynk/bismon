...
(see \cite{Pitrat:blog} - it explains that all the 500KLOC of the C
code of CAIA are generated), Ocaml (cf \cite{Ocaml,
  Leroy-modular-modules} and many other papers by Xavier Leroy and the
\href{http://gallium.inria.fr/}{Gallium} team at INRIA), Self (cf
\cite{Ungar:1987:Self}), and Clasp (cf \cite{Schafmeister:2015:CLASP})
...
projections, e.g. \cite{Futamura:1999:PartialEval}).
