...
Databases are routinely capable to deal with large amount of data
(e.g. many terabytes), much more than the available RAM, because the
application using some database is \emph{explicitly} fetching and
updating only a tiny part of it. Hence
