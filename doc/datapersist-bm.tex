...
status (notably the queue of objects to scan, and the hash-set of dumped
...
\index{dump scan@\texttt{dump\_scan}} message is sent\footnote{The
...
\texttt{temporary\_attribute\_object} are not dumped.
