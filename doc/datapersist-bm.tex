...
algorithm used to dump \index{dump} a persistent \index{persistent
  state} state, and classical copying garbage collection
\index{garbage collection} algorithms (such as
