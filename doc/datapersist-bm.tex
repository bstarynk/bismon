...
values during the emission phase.  The \texttt{dump\_data} \index{dump
  data@\texttt{dump\_data}} message is sent\footnote{Extra arguments
...
- \index{payload} if relevant-, after having dumped its class,
attributes and components. But attributes \index{attribute} which are
direct or indirect instances of \texttt{temporary\_attribute\_object}
\index{temporary attribute object@
