...
(see also \cite{Cormen:2009:Intro-algo, Christian:2017:algorithms})
used to dump \index{dump} a persistent \index{persistent state} state,
and classical copying or
