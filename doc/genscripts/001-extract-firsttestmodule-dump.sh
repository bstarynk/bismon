...
# object first_test_module in store§2.bmon
echo running genscripts/001-extract-firsttestmodule-dump.sh on $(wc -l ../store§2.bmon) 1>&2

sed -e '/«_9oXtCgAbkqv_4y1xhhF5Nhz/,/»_9oXtCgAbkqv_4y1xhhF5Nhz/p' -n ../store§2.bmon
