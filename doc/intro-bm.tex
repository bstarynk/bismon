...
%
      ...
      & \label{sec:staticanalys}; §\ref{subsec:compilinkext}
      & static analysis involves \emph{generated} GCC plugins, as (in this D1.3v1 draft)
      incompletely explained in \label{sec:staticanalys}; compiler and linker extensions
      are (in D1.3v1) drafted in §\ref{subsec:compilinkext}  \\
      \hline
%-      \multirow{4}{*}{%
%-     \begin{minipage}[t]{0.18\textwidth}
%-       \smallskip
