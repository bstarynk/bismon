...
%  The \textit{Bismon monitor} is occasionally starting some external
%  processes (e.g. for the compilation of \emph{C} code dynamically
%  generated by \textit{Bismon}, before \texttt{dlopen}-ing such
%  modules). In practice the Bismon monitor is likely to be started
%  every day.
