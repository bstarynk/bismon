...
\begin{itemize}
  ...
  \item be knowing a bit the \index{C11}{C11} standard
    ...
    \index{C++11}{C++11} one (\cite{CplusPlus11:std}) or newer standards like \href{http://www.open-std.org/JTC1/SC22/WG14/www/docs/n2573.pdf}{C2x} and
...
\item be interested in static source code analysis, so have already
  ...
  \item be interested by knowledge base tools and symbolic artificial
    ...
    engineeering problems (see \cite{rich2014readings,
      ...
      Lenzerini:2021:metamodelling, FITZ:2019:metamodel-cyberphysys,
      Sumi:2007:conversational, Chen:2020:ontology-complex-sys,
      Theiler:2020:metaization}).
...
The reader should be aware that there are well known theoretical
limitations regarding static source code analysis, in particular
related to the $\lambda$-calculus (see
\cite{Hindley:2008:lambda-combinators}), typing (see
\cite{pierce:2002:types}) and Rice's theorem (see
\cite{moyen:2019:more}).
