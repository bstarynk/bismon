...
\begin{itemize}
  ...
  \item \textbf{dynamic typing}, like many scripting languages (such
    ...
    \footnote{\label{fn:initial-gc} Improving that GC is a
      ...
      \cite{Hofstadter:1979:GEB}). We should consider later using MPS
      from \bmurl{https://www.ravenbrook.com/project/mps/} but doing
      that could require recoding or regenerating \emph{a lot} of code, since MPS has specific calling conventions and invariants, including A-normal form. So, switching to MPS in \emph{Bismon} would require at least several months of work.}, if good performance and scalability is wanted in \emph{Bismon}.
