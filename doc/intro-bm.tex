...
%
      ...
      incompletely explained in §\ref{sec:staticanalys}; compiler and linker extensions
...
\item have contributed or participated to some free software or open
  ...
  \cite{Weber:2004:SuccessOpenSource, Tirole:2016:EcoBienCommun,
    Nagle:2018:Contributing, DiCosmo:1998:Holdup}) implications, the
  practical work flow, the importance of developer communities.
...
etc....), notably for IoT\index{IoT} (see \cite{Carpent:2018:RRA,
  Ahmad:2018:ModelBasedIoT, Laszlo:2018:Vessedia}); however the
relation between an explicited defect and a source code property is
  ...
  \item \emph{Bismon} should also generate the C++ code of \emph{GCC
    ...
    \begin{enumerate}
      \item usually, the GCC plugin~\footnote{It is tempting to call
        ...
        targetting some RaspberryPi, it could be a GCC plugin
        targetting the \texttt{arm-linux-gnueabi-gcc-8} cross-compiler
