...
security in IoT software, and even more on static source code analysis
in general. Several conferences are dedicated to static
analysis~\footnote{The 25\textsuperscript{th} Static Analysis
  Symposium will happen in august 2018, see
  ...
  analysis.}. All dominant C compilers (notably GCC and Clang) are
using and providing static source code analysis techniques for
optimizations and warnings purposes. Many taxonomies of software
defects already exist, notably for IoT .
