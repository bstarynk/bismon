...
\begin{table}
  ...
  \medskip
  \begin{relsize}{-1.3}
    \begin{tabular}{|p{0.19\textwidth}|p{0.36\textwidth}|p{0.18\textwidth}|p{0.18\textwidth}|}
...
%
      ...
      & \textbf{ST1.3.1} definition of data formats and protocols & BB & CC \\
      \cline{2-4}
      & \textbf{ST1.3.2} significant patches to existing free software components & EE & FF \\
      \cline{2-4}
      & \textbf{ST1.3.3} design and implementation of the persistent monitor & HH & II \\
      \cline{2-4}
      & \textbf{ST1.3.4} design and implementation of the compiler and linker extension & KK & LL \\
      \hline
%-      \multirow{4}{*}{%
%-     \begin{minipage}[t]{0.18\textwidth}
%-       \smallskip
