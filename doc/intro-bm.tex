...
\begin{itemize}
  ...
  \item be fluent in C (cf. \cite{Kernighan:1988:CPL, gusted:t2019:modern}) and/or C++
    (\cite{Stroustrup:2014:CplusPlus, Stroustrup:2020:thriving}) programming (notably on Linux
...
\item be interested in static source code analysis, so have already
  ...
  \item be interested by knowledge base tools and symbolic artificial
    ...
    \cite{rich2014readings, beckert2007verification,
      ...
      TWO:2001:WAPATV, Starynkevitch2007Multistage, Starynkevitch:2009:grow,
