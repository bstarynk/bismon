...
analysis infrastructure, that is with a single \emph{persistent
  monitor} process. That persistent monitor would be some
``server-like'' program, probably started every working day in the
morning, and gently stopped every evening. It needs to keep its
