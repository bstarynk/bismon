...
\begin{figure}[h]
  \begin{center}
    \begin{tabular}{lclp{5cm}}
      ...
      \end{minipage}
      & {\relsize{-1}{Bismon tuples encoded  with \texttt{"!tup"} JSON attribute giving the JSON array of corresponding object ids : ~  \mbox{$\mathit{oid}_i = \mathrm{objid} (\omega_i)$}
            }}
             \\
      %%%
      ...
      \begin{minipage}{3.5cm}
         ...
         \hspace*{1.2em}  $\mathtt{\texttt{[}} ~ \mathit{oid}_1 \ldots \mathit{oid}_n ~ \mathtt{\texttt{]}}$ \texttt{\textbf{\}}}
      \end{minipage}
      & {\relsize{-1}{Bismon sets encoded  with \texttt{"!tup"} JSON attribute giving the JSON array of corresponding object ids : ~  \mbox{$\mathit{oid}_i = \mathrm{objid} (\omega_i)$}
            }}
             \\
    \end{tabular}
    \smallskip
