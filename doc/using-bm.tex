...
\cite{donzeaugouge:inria-mentor}) needed\footnote{See also end of
  \ref{subsubsec:about-bismon} above.} in \emph{Bismon} by its
homoiconicity \index{homoiconicity}, and used by the
\index{expert!static analysis} static analysis expert, won't handle
lines of tokens in an editor widget\footnote{Of course, using
