...
\textit{extractornode} in the statement, which should be a node.  Such
a JSON extraction is compositional, has side-effects, and could
fail. When the extraction has succeeded, the given
\textit{sub-statements}... are executed.
