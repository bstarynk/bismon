...
////////////////
static gboolean postponed_gui_handler_bm (gpointer udata);
...
#define MIN_POSTPONED_MILLISEC_BM 20
  ...
  (void) g_timeout_add (deltams, postponed_gui_handler_bm, NULL);
}                               /* end register_gui_postponed_BM */



gboolean
postponed_gui_handler_bm (gpointer udata)
{
  ASSERT_BM (udata == NULL);
  FATAL_BM ("unimplemented postponed_gui_handler_bm");
#warning unimplemented postponed_gui_handler_bm
}                               /* end postponed_gui_handler_bm */
