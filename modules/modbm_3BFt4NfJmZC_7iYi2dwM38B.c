...
extern objrout_sigBM crout_4qnxZdea4qp_3ghonuiHfNf_BM;  //#14 !dump_data°persistent_json_object<o_json (o_dumper o_strbuf)
...
extern objrout_sigBM crout_7MtjMTkmErH_2zSJ1YDKHVi_BM;  //#17 !dump_value°double_float < v_dbl (o_strbuf o_dump v_depth)

extern objrout_sigBM crout_82ho9wUUDji_4peMLha4PXl_BM;  //#18 findobj_scan_minifunc

extern objrout_sigBM crout_8dG7KZHgf3t_4ia32mWZqVQ_BM;  //#19 !for_loop#readmacro (v_node v_lineno v_colpos o_parser)

extern objrout_sigBM crout_8imWClcIFKt_6w2H2ouB4I6_BM;  //#20 iterate_sequence_minifunc

extern objrout_sigBM crout_9CG8SKNs6Ql_4PiHd8cnydn_BM;  //#21 !clear°dict_object minifun


// declare 35 constants
objectval_tyBM *constob_3BFt4NfJmZC_7iYi2dwM38B_BM[35 + 1];
const char *const constid_3BFt4NfJmZC_7iYi2dwM38B_BM[35 + 1];
...
{                               // start of _0cUdonky1bM_4IVhwlVRBMk
  ...
  const closure_tyBM *callclos_0cUdonky1bM_4IVhwlVRBMk
...
/*objstrbufferprintobjid _1XzuICo9tMz_2FMOEMMgKHC:*/
        ...
        objectval_tyBM *ob__1XzuICo9tMz_2FMOEMMgKHC =
...
/*objstrbufferprinthtmlstringval:*/
            if (objhasstrbufferpayl_BM
              ...
              objstrbufferencodedhtmlpayl_BM (( /*o_webex: */ _.
                                               o_5JuT4FgNFFh_7McrTYeT3jx),
                                              bytstring_BM ( /*v_queryfoo: */
                                                            _.
                                                            v_8s5u19T0e2h_9ZqrO3YZDVS),
                                              lenstring_BM ( /*v_queryfoo: */
                                                            _.
                                                            v_8s5u19T0e2h_9ZqrO3YZDVS));;
...
/*objstrbufferprinthtmlstringval:*/
            if (objhasstrbufferpayl_BM
              ...
              objstrbufferencodedhtmlpayl_BM (( /*o_webex: */ _.
                                               o_5JuT4FgNFFh_7McrTYeT3jx),
                                              bytstring_BM ( /*v_postbar: */
                                                            _.
                                                            v_2nnQQ6Lvtpl_4oCJYx90FlI),
                                              lenstring_BM ( /*v_postbar: */
                                                            _.
                                                            v_2nnQQ6Lvtpl_4oCJYx90FlI));;
...
/*objstrbufferprinthtmlstringval:*/
        if (objhasstrbufferpayl_BM
            ...
            && isstring_BM ( /*flocaltimestring: */ (value_tyBM)
                            flocaltimestring_BM (("%c"),
                                                 (time_t) ( /*timenow: */
                                                 (intptr_t) time (NULL)))))
          objstrbufferencodedhtmlpayl_BM (( /*o_webex: */ _.
                                           o_5JuT4FgNFFh_7McrTYeT3jx),
                                          bytstring_BM (
                                          /*flocaltimestring: */ (value_tyBM)
                                         flocaltimestring_BM (("%c"),
                                                              (time_t) (
                                                              /*timenow: */
                                                              (intptr_t)
                                                             time (NULL)))),
     lenstring_BM ( /*flocaltimestring: */ (value_tyBM)
                   flocaltimestring_BM (("%c"),
                                        (time_t) ( /*timenow: */ (intptr_t)
                                                  time (NULL)))));;
...
/*¤¤objwebexchangecompletepayl:*/
      ...
      ("obsolete objwebexchangecompletepayl");
                                                                                ...
                                                                                /*return _8VHbQSvNRq4_44CGuKiIMLb:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                // returned 
      /*o_webex: */ _.o_5JuT4FgNFFh_7McrTYeT3jx;
...
{                               // start of _0g1CBaxjMIB_7NZdyHUikLG
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[2] /*|_0g1CBaxjMIB_7NZdyHUikLG */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // locking 1:
  ...
  const closure_tyBM *callclos_0g1CBaxjMIB_7NZdyHUikLG
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
/*debug out#readmacro start  v_node lineno colpos o_parser*/
      DBGPRINTF_BM
        ("out#readmacro start €%.9s v_node=%s lineno#%ld colpos#%ld o_parser=%s",
...
/*when _1j5eDZEaK15_1f7jqPaTIVw:*/
      ( /*equal_object: */
      (( /*o_conn: */ _.o_13K9OfeXRZR_84nyRTtoj81) ==
       ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[1] /*!in */ ))))
...
/*endcond _9wmUQdGs520_80QjLaRO5pa*/
                                                        ...
                                                        /*o_varbuffer: */ _.o_44FTjgRn7Px_0AfVbgmgP6l =
                                                        //assign _5Oe3n0McSTK_9Wa3aPWE2FN  
      /*val_to_object:*/
...
/*when _7J0ls8Ka2yx_3fBvjSLJUo1:*/
      ( /*is_null: */
      (( /*o_varbuffer: */ _.o_44FTjgRn7Px_0AfVbgmgP6l) == NULL))
      {                         //body when _7J0ls8Ka2yx_3fBvjSLJUo1  

        {                       // run _8PSnZGiFcKI_0SN4CeFLS2d  
/*syntax-error no o_varbuffer*/
          objparserrorprintf_BM ( /*o_parser: */ _.o_5fGGXIme43z_0mc4HIwzzMj,
                                 CURFRAME_BM, /*i_lineno: */
                                 _.n_6x2LYnlYgQG_6FXtmtwODgo, /*i_colpos: */
                                 _.n_2sygPI8PHgL_4RgFW0PkZbd,
                                 "missing varbuffer in ^out([*in(...)] varbuffer outputs...)");
          ;
...
//+ #10/14 of block _8Zow03fhyT0_8uAZxZPDM5k :: 
                                                ...
                                                /*v_comp: */ _.v_0ZL8gaI6sH8_7UPhmAQcwMe =
                                                //assign _2mmddNFAEgd_4oaodbVOC2R  
      /*nodenthson:*/
      nodenthson_BM (( /*v_node: */ _.v_2BkOxf2KbS8_3bswrKbmgjy),
                     ( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B));
                                                ...
                                                //assign _4fVIgCrLJzj_8pmTR4KWfsE  
      /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B;
...
/*when _6utotmA8SWn_4ZHG6JuneX9:*/
      ...
      {                         //body when _6utotmA8SWn_4ZHG6JuneX9  
                                                        /*o_resobj: */ _.o_4jyHvEiEzZ1_9ck99ShNTHx =
                                                        //assign _6fXfi9x99V4_8dSOffH1aBN   
/*makeobj:*/ makeobj_BM ();
...
/*endcond _0vn7ueI4Bxr_4hnicjlB78i*/
    ...
    {                           // begin lockobj _2JvEoBxMhy7_9DZyjgGfHlv 
      objectval_tyBM *curlockedob_2JvEoBxMhy7_9DZyjgGfHlv =
        ( /*o_resobj: */ _.o_4jyHvEiEzZ1_9ck99ShNTHx);
      if (objlock_BM (curlockedob_2JvEoBxMhy7_9DZyjgGfHlv))
        {
          locked_2JvEoBxMhy7_9DZyjgGfHlv =
            curlockedob_2JvEoBxMhy7_9DZyjgGfHlv;
            ...
            (!( /*objectisinstance: */
               objectisinstance_BM (( /*o_resobj: */ _.
                                    ...
                                    ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[34]
                                      /*!basiclo_outstmt */ ))))))
            {                   //body when _8g6tUrNeSaK_9pEbME2mJdL  
          ...
          {                     // start cexpansion _1WbhqznDBxp_9TvXYU0SNFk - objputattr  
            /*objputattr:*/
              objputattr_BM (( /*o_resobj: */ _.o_4jyHvEiEzZ1_9ck99ShNTHx),
                             ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[3] /*!out */
                               )),
                             ( /*o_varbuffer: */ _.
                              o_44FTjgRn7Px_0AfVbgmgP6l));
...
// while _3TURPJpX7th_5T3UCSyjzvv comp#0:  
                                                        /*v_comp: */ _.v_0ZL8gaI6sH8_7UPhmAQcwMe =
                                                        //assign _2JzmSXbqwbW_6p4oLUW30vv   
              /*nodenthson:*/
              nodenthson_BM (( /*v_node: */ _.v_2BkOxf2KbS8_3bswrKbmgjy),
                             ( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B));
...
/*debug loop out#readmacro ii v_comp v_node o_resobj*/
              DBGPRINTF_BM
                ("loop out#readmacro €%.9s ii#%ld v_comp=%s v_node=%s o_resobj=%s",
...
// while _3TURPJpX7th_5T3UCSyjzvv comp#3:  
                                                        /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B =
                                                        //assign _95oYoloIJKx_07EE4Ommri7   
              /*add_int:*/ (( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B) + (1));
  ...
  /*-endwhile _3TURPJpX7th_5T3UCSyjzvv */
          ...
          {                     // start cexpansion _4k7bXst8Ysh_6rBll1H8CUo - objtouchnow  
            /*objtouchnow:*/ objtouchnow_BM ( /*o_resobj: */ _.
                                             o_4jyHvEiEzZ1_9ck99ShNTHx);;
...
/*debug out#readmacro end o_resobj*/
            DBGPRINTF_BM ("out#readmacro end €%.9s o_resobj=%s",
                          ...
                          objectdbg_BM ( /*o_resobj: */ _.
                                        o_4jyHvEiEzZ1_9ck99ShNTHx));
            ;
          }                     // end run _0nQH8PHR97P_03T6CUirdCG 

                                                                                        /*return _0IHnwGG1GxP_4kooak9wiyM:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned 
            /*o_resobj: */ _.o_4jyHvEiEzZ1_9ck99ShNTHx;
          goto epilog_0g1CBaxjMIB_7NZdyHUikLG;

          objunlock_BM (locked_2JvEoBxMhy7_9DZyjgGfHlv),
            locked_2JvEoBxMhy7_9DZyjgGfHlv = NULL;
        }
...
epilog_0g1CBaxjMIB_7NZdyHUikLG:__attribute__((unused));
                                // routine _0g1CBaxjMIB_7NZdyHUikLG epilogue:
  // unlocking 1:
...
{                               // start of _0JktC4mAHCa_1KNr6uMIqIi
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[4] /*|_0JktC4mAHCa_1KNr6uMIqIi */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
  ...
  const closure_tyBM *callclos_0JktC4mAHCa_1KNr6uMIqIi
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
{                               // start of _0SinERsgdvQ_57dLCP63i9r
  ...
  const closure_tyBM *callclos_0SinERsgdvQ_57dLCP63i9r
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
      ...
      {                         //body when _7aRr2DYoXS7_0jbH59RVcFR  
        ...
        {                       // run _8y60zCwYsj4_4MKReQrfwGI  
          ...
          ;
                                                                                        ...
                                                                                        /*return _8X0BDdDTJe6_8OoRGA5RDeF:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*o_arg: */ _.o_7daWyW7jPyL_0EvyGgObjJm;
...
{                               // start of element_of_closed_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[6] /*|element_of_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  {                             // fetch 1 closed values in element_of_closed_minifunc:
    ...
    const unsigned nbclosed_0YOXUe7rEJC_3jFMjOAQRs9 =
...
/*when _2U8EKCOdizu_8BNXvpmwd43:*/
      ...
      {                         //body when _2U8EKCOdizu_8BNXvpmwd43  
                                                                                        /*return _4rFgWAf3aqA_0UBP8b4hESV:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*o1: */ _.o_97rnxb0KFqq_44veN75DG2E;
...
{                               // start of _110awzb480c_0n4frovb2yV
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[7] /*|_110awzb480c_0n4frovb2yV */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
  ...
  const closure_tyBM *callclos_110awzb480c_0n4frovb2yV
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
/*debug dump_data°contributor_class start o_contrib o_dump o_strbuf*/
      DBGPRINTF_BM
        ("dump_data°contributor_class start €%.9s o_contrib=%s o_dump=%s o_strbuf="
         FMTOBJSTRBUF_BM, "_2mZ2rKmc7Mo_1SZ28mRdggC",
         objectdbg_BM ( /*o_contrib: */ _.o_4oqlg02xVwJ_918wypibNLb),
         objectdbg1_BM ( /*o_dump: */ _.o_0iwWM98KNVX_0tO8Cz41val),
         OBJ2STRBUFOUT_BM ( /*o_strbuf: */ _.o_41F1rKwGbaA_30OJWKsqNWy));
      ;
...
/*out_half_id:*/ char idbuf_1qaaJG5UYhn_5j3TgEyZ2tp_n2[32] = { 0 };
      ...
      /*out newline:*/ objstrbuffernewlinepayl_BM ( /*o_strbuf: */ _.
                                                   o_41F1rKwGbaA_30OJWKsqNWy);
                                                                                ...
                                                                                /*return _74M1FckZwVg_6lzAfAc8gdR:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                // returned 
...
epilog_110awzb480c_0n4frovb2yV:__attribute__((unused));
                                // routine _110awzb480c_0n4frovb2yV epilogue:
  if (stkf)
    stkf->stkfram_callfun = NULL;
  return /*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ;
...
{                               // start of _22Zd68WPKUO_6AoIuBcbUb2
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[10] /*|_22Zd68WPKUO_6AoIuBcbUb2 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
  ...
  const closure_tyBM *callclos_22Zd68WPKUO_6AoIuBcbUb2
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
// while _0SWi4IZCeP3_0VPExGvOasL comp#2:  
  ...
  /*-endwhile _0SWi4IZCeP3_0VPExGvOasL */
                                                                                ...
                                                                                /*return _8pmMgF3SSuE_2COzwjyI8lS:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                // returned 
...
{                               // start of _2bZ4BfCci5V_3WTzG7V25y4
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[11] /*|_2bZ4BfCci5V_3WTzG7V25y4 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
  ...
  const closure_tyBM *callclos_2bZ4BfCci5V_3WTzG7V25y4
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
                ...
                objdictputpayl_BM (( /*odict: */ _.o_7n2SLLuWOjH_4ArhFUjmckz),
                                   ...
                                   ( /*v_val: */ _.
                                    v_5jRQCD1qTko_61I0j04ugAA));
                                                                                        ...
                                                                                        /*return _3Q8xwomyj4D_36oIs4VyEfB:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned   
              /*odict: */ _.o_7n2SLLuWOjH_4ArhFUjmckz;
...
{                               // start of identity_minifunc
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[12] /*|identity_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  const closure_tyBM *callclos_2nl9zcaSUwe_8UBiMp1OuMk
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
startblock__3SCriDcyk4V_8JxBGUtl9lK:__attribute__((unused));
  {                             /* +block _3SCriDcyk4V_8JxBGUtl9lK */
                                                                                /*return _7r8EbXcv6UI_01uYrCD2Myn:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                // returned 
...
{                               // start of _3iiht57Wrs1_5NbiUi27oBn
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[13] /*|_3iiht57Wrs1_5NbiUi27oBn */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
  ...
  const closure_tyBM *callclos_3iiht57Wrs1_5NbiUi27oBn
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
          ...
          /*objlistprependpayl:*/
            objlistprependpayl_BM (( /*o1: */ _.o_97rnxb0KFqq_44veN75DG2E),
                                   ( /*v2: */ _.v_09RxU8xDco3_2Zxwfb13oDZ));
                                                                                        ...
                                                                                        /*return _3Hj8WH5oi59_3L07vytBdDJ:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*o1: */ _.o_97rnxb0KFqq_44veN75DG2E;
...
{                               // start of same_as_closed_minifunc
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[14] /*|same_as_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  {                             // fetch 1 closed values in same_as_closed_minifunc:
    const closure_tyBM *callclos_3yQlckX4DRh_4b9l9FBSSSL =
      (stkf && stkf->stkfram_pA.htyp == typayl_StackFrame_BM)
      ? (closurecast_BM (stkf->stkfram_callfun)) : NULL;
    const unsigned nbclosed_3yQlckX4DRh_4b9l9FBSSSL =
...
( /*v_arg: */ _.v_4Q4WBLjAPTV_5WVLmhAvCJY)))
      {                         //body when _5Ad0ZdurQuC_1A6Kn7qopbm  
                                                                                        /*return _1qFf9AUO2W9_8azcQljqB3I:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*v_arg: */ _.v_4Q4WBLjAPTV_5WVLmhAvCJY;
...
{                               // start of _3HAeZZQ0q7b_7qyDsekaz7Y
  ...
  _.stkfram_head.rlen = 2;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[16] /*|_3HAeZZQ0q7b_7qyDsekaz7Y */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  const closure_tyBM *callclos_3HAeZZQ0q7b_7qyDsekaz7Y
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
/*when _0IRlnxNrCtM_6W21xnJjzmn:*/
      ...
      {                         //body when _0IRlnxNrCtM_6W21xnJjzmn  
                                                                                        /*return _516tXf2eeNb_8VGPLYEode5:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*o1: */ _.o_97rnxb0KFqq_44veN75DG2E;
...
{                               // start of equal_to_closed_minifunc
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[18] /*|equal_to_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  {                             // fetch 1 closed values in equal_to_closed_minifunc:
    const closure_tyBM *callclos_4iEFTEcHxeb_6lH464uFkTC =
      (stkf && stkf->stkfram_pA.htyp == typayl_StackFrame_BM)
      ? (closurecast_BM (stkf->stkfram_callfun)) : NULL;
    const unsigned nbclosed_4iEFTEcHxeb_6lH464uFkTC =
...
/*when _8hUpJbSLQUS_88aqogJAi2Q:*/
      ...
      {                         //body when _8hUpJbSLQUS_88aqogJAi2Q  
                                                                                        /*return _3dJ2b1hmBuw_7Pu5iDjauLr:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*v1: */ _.v_5EEITf6IFH7_4DbKG99zcPW;
...
{                               // start of _4qlegfkPzrC_17skUfJP7v8
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[19] /*|_4qlegfkPzrC_17skUfJP7v8 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
  ...
  const closure_tyBM *callclos_4qlegfkPzrC_17skUfJP7v8
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
//+ #4/9 of block _3oMW0T4HlXx_8r7NLpyK1J8 ::  
    ...
    {                           // run _40XgQGIUZQY_246JbHmppCN 
      (send3_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[31] /*|clear */ )),
       /*sel: */ ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[9] /*|dump_value */ )),
((struct stackframe_stBM *) &_),
...
// while _9gJT0jotyox_8JQNlJn3qh6 comp#2:  
      ...
      {                         // run _4BOu5jhqyAD_3HGfVAY5hFx  
        (send3_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[32] /*|put */ )),
         /*sel: */ 
((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[9] /*|dump_value */ )), ((struct stackframe_stBM *) &_),
                   ( /*osbuf: */ _.o_6opEz55NyNu_3JKpBgxLijw),
                   ( /*odumper: */ _.o_3cTC8W7d75H_1vteOyEoAao),
                   (((value_tyBM) 0x3 /*!1 */ ))));
...
// while _9gJT0jotyox_8JQNlJn3qh6 comp#4:  
      ...
      {                         // run _634ecJogXve_7sycLMYAfdT  
        (send3_BM (( /*v_str: */ _.v_167WczZjWtG_3FofhJxQWJi), /*sel: */
         ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[9] /*|dump_value */ )),
((struct stackframe_stBM *) &_),
                   ( /*osbuf: */ _.o_6opEz55NyNu_3JKpBgxLijw),
                   ( /*odumper: */ _.o_3cTC8W7d75H_1vteOyEoAao),
                   (((value_tyBM) 0x3 /*!1 */ ))));
...
// while _9gJT0jotyox_8JQNlJn3qh6 comp#5:  
      {                         // start cexpansion _3fFn9uY0hNS_2YU6fn9QOSh - objstrbuffernewlinepayl   
        /*objstrbuffernewlinepayl:*/ objstrbuffernewlinepayl_BM ( /*osbuf: */
                                                                 _.
                                                                 o_6opEz55NyNu_3JKpBgxLijw);
      ...
      /*objstrbufferappendcstrpayl:*/
        objstrbufferappendcstrpayl_BM (( /*osbuf: */ _.
                                       ...
                                       ("\n~)\n"));
                                                                                ...
                                                                                /*return _9IH3fglmCon_9bHWhFstP4K:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                // returned 
      /*odict: */ _.o_7n2SLLuWOjH_4ArhFUjmckz;
...
value_tyBM crout_4qnxZdea4qp_3ghonuiHfNf_BM     //#14
  (struct stackframe_stBM *stkf,        //
//!dump_data°persistent_json_object<o_json (o_dumper o_strbuf)
   // 3 arguments
   const value_tyBM arg0,       // o_json
   const value_tyBM arg1,       // o_dump
   const value_tyBM arg2,       // o_strbuf
   const value_tyBM arg3_ __attribute__((unused)),
   const quasinode_tyBM * restargs_ __attribute__((unused)))
{                               // start of _4qnxZdea4qp_3ghonuiHfNf
  struct frame_4qnxZdea4qp_3ghonuiHfNf_BMst
  {
    typedhead_tyBM stkfram_head;
    struct stackframe_stBM *stkfram_prev;
    objectval_tyBM *stkfram_descr;
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[20] /*|_4qnxZdea4qp_3ghonuiHfNf */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
  _.o_0kRPCsvLkdT_75x9PWrFQYz = objectcast_BM (arg0);   // o_json
  _.o_0iwWM98KNVX_0tO8Cz41val = objectcast_BM (arg1);   // o_dump
  _.o_41F1rKwGbaA_30OJWKsqNWy = objectcast_BM (arg2);   // o_strbuf
  // fetched 3 arguments.
  // no closed values in _4qnxZdea4qp_3ghonuiHfNf.
  const closure_tyBM *callclos_4qnxZdea4qp_3ghonuiHfNf
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
    : NULL;
  const unsigned nbclosed_4qnxZdea4qp_3ghonuiHfNf __attribute__((unused)) = 0;
  // routine _4qnxZdea4qp_3ghonuiHfNf body:

startblock__9lbn8XYjnv9_50alo8Io3Lx:__attribute__((unused));
  {                             /* +block _9lbn8XYjnv9_50alo8Io3Lx */

    {                           // run _3TO1oP0OiOx_5ye8bwZUpLK 
/*debug start dump_data°persistent_json_object o_json o_dump o_strbuf*/
      DBGPRINTF_BM
        ("start dump_data°persistent_json_object €%.9s o_json=%s o_dump=%s o_strbuf=%s",
         "_3TO1oP0OiOx_5ye8bwZUpLK",
         objectdbg_BM ( /*o_json: */ _.o_0kRPCsvLkdT_75x9PWrFQYz),
         objectdbg1_BM ( /*o_dump: */ _.o_0iwWM98KNVX_0tO8Cz41val),
         objectdbg2_BM ( /*o_strbuf: */ _.o_41F1rKwGbaA_30OJWKsqNWy));
      ;
    }                           // end run _3TO1oP0OiOx_5ye8bwZUpLK 


    {                           // start out _4z97h3W9aUs_0H2aWPef783 to o_strbuf  
      /*out newline:*/ objstrbuffernewlinepayl_BM ( /*o_strbuf: */ _.
                                                   o_41F1rKwGbaA_30OJWKsqNWy);
      /*out string:*/ objstrbufferappendcstrpayl_BM ( /*o_strbuf: */ _.
                                                     o_41F1rKwGbaA_30OJWKsqNWy,
...
///v_rawstr = json_dumps(objgetjansjsonpayl_BM(o_json), JSON_SORT_KEYS | JSON_INDENT (1))
                                              /*v_rawstr: */ _.sc_3As0a225cux_6I7tccmqVOP =
                                              /*_38ttG1Te65E_0mjeMWVgY9R*/
        json_dumps (objgetjansjsonpayl_BM
                    ( /*o_json: */ _.o_0kRPCsvLkdT_75x9PWrFQYz),
                    JSON_SORT_KEYS | JSON_INDENT (1));
      ;
...
//free and clear v_rawstr
      free ( /*v_rawstr: */ _.sc_3As0a225cux_6I7tccmqVOP), /*v_rawstr: */
        _.sc_3As0a225cux_6I7tccmqVOP = NULL;
      ;
    }                           // end run _05e3o09maMk_6kZTUOLmWA9 


                                                                                /*return _85ZcTOEPKbK_2uhA2CtZkUH:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                // returned 
      /*o_json: */ _.o_0kRPCsvLkdT_75x9PWrFQYz;
...
epilog_4qnxZdea4qp_3ghonuiHfNf:__attribute__((unused));
                                // routine _4qnxZdea4qp_3ghonuiHfNf epilogue:
  if (stkf)
    stkf->stkfram_callfun = NULL;
  return /*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ;
}                               // end _4qnxZdea4qp_3ghonuiHfNf routine#14 _4qnxZdea4qp_3ghonuiHfNf
...
{                               // start of _4M7lr5cU6VD_5hxmeH3baBf
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[21] /*|_4M7lr5cU6VD_5hxmeH3baBf */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
  ...
  const closure_tyBM *callclos_4M7lr5cU6VD_5hxmeH3baBf
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
          ...
          /*objlistappendpayl:*/
            objlistappendpayl_BM (( /*o1: */ _.o_97rnxb0KFqq_44veN75DG2E),
                                  ( /*v2: */ _.v_09RxU8xDco3_2Zxwfb13oDZ));
                                                                                        ...
                                                                                        /*return _86rGd2LLytX_4xsXHoCmw1Y:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*o1: */ _.o_97rnxb0KFqq_44veN75DG2E;
...
{                               // start of _5j8LpQULt1p_9oeOaqmfYYr
  ...
  const closure_tyBM *callclos_5j8LpQULt1p_9oeOaqmfYYr
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
value_tyBM crout_7MtjMTkmErH_2zSJ1YDKHVi_BM     //#17
  (struct stackframe_stBM *stkf,        //
...
{                               // start of _7MtjMTkmErH_2zSJ1YDKHVi
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[27] /*|_7MtjMTkmErH_2zSJ1YDKHVi */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 4 arguments:
  ...
  const closure_tyBM *callclos_7MtjMTkmErH_2zSJ1YDKHVi
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
startblock__2CQSAWSZYj5_98YYbJMAfN2:__attribute__((unused));
  {                             /* +block _2CQSAWSZYj5_98YYbJMAfN2 */
    ...
    {                           // run _61LFWdfV7PM_5veZwiRLC2y 
      ...
      double d__61LFWdfV7PM_5veZwiRLC2y =
        getdouble_BM ( /*v_dbl: */ _.v_7m9aaeG1xHx_6pPkRL8xYYT);
      if (objstrbufferoutdoublepayl_BM
          ( /*o_strbuf: */ _.o_41F1rKwGbaA_30OJWKsqNWy,
           d__61LFWdfV7PM_5veZwiRLC2y))
        objstrbufferprintfpayl_BM ( /*o_strbuf: */ _.
                                   o_41F1rKwGbaA_30OJWKsqNWy, "|==%g| ",
                                   d__61LFWdfV7PM_5veZwiRLC2y);
      else
      ...
      ;
                                                                                ...
                                                                                /*return _8SBPWoQTYFm_5EoKbU71sQi:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                // returned 
...
epilog_7MtjMTkmErH_2zSJ1YDKHVi:__attribute__((unused));
                                // routine _7MtjMTkmErH_2zSJ1YDKHVi epilogue:
  if (stkf)
    stkf->stkfram_callfun = NULL;
  return /*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ;
}                               // end _7MtjMTkmErH_2zSJ1YDKHVi routine#17 _7MtjMTkmErH_2zSJ1YDKHVi
...
{                               // start of findobj_scan_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[28] /*|findobj_scan_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  {                             // fetch 1 closed values in findobj_scan_minifunc:
    const closure_tyBM *callclos_82ho9wUUDji_4peMLha4PXl =
      (stkf && stkf->stkfram_pA.htyp == typayl_StackFrame_BM)
      ? (closurecast_BM (stkf->stkfram_callfun)) : NULL;
    const unsigned nbclosed_82ho9wUUDji_4peMLha4PXl =
...
value_tyBM crout_8dG7KZHgf3t_4ia32mWZqVQ_BM     //#19
  (struct stackframe_stBM *stkf,        //
...
{                               // start of _8dG7KZHgf3t_4ia32mWZqVQ
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[29] /*|_8dG7KZHgf3t_4ia32mWZqVQ */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // locking 1:
  ...
  {                             // fetch 2 closed values in _8dG7KZHgf3t_4ia32mWZqVQ:
    const closure_tyBM *callclos_8dG7KZHgf3t_4ia32mWZqVQ =
      (stkf && stkf->stkfram_pA.htyp == typayl_StackFrame_BM)
      ? (closurecast_BM (stkf->stkfram_callfun)) : NULL;
    const unsigned nbclosed_8dG7KZHgf3t_4ia32mWZqVQ =
      closurewidth_BM ((const value_tyBM) callclos_8dG7KZHgf3t_4ia32mWZqVQ);
...
/*debug for_loop#readmacro start v_node lineno colpos o_parser o_class o_verb*/
      DBGPRINTF_BM
        ("for_loop#readmacro start €%.9s v_node=%s lineno#%ld colpos#%ld o_parser=%s o_class=%s o_verb=%s",
...
//+ #4/18 of block _5SooyVqYKIT_4dQpCFeTVkV :: 
                                                ...
                                                /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B =
                                                //assign _6fyZzQUoppO_8VopYAJeuG9  
      0;
...
/*when _8YCEgWraf8u_6RbayBBuUw2:*/
      ( /*equal_object: */
      (( /*o_conn: */ _.o_13K9OfeXRZR_84nyRTtoj81) ==
       ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[17] /*!label */ ))))
      {                         //body when _8YCEgWraf8u_6RbayBBuUw2  
                                                        /*o_curlab: */ _.o_79dADic8Iro_3skCK4hK3iW =
                                                        //assign _2oLGfTIC3p3_5aXkVmeoQew   
          /*val_to_object:*/
          objectcast_BM ( /*nodenthson: */
                         nodenthson_BM (( /*v_comp: */ _.
                                         v_0ZL8gaI6sH8_7UPhmAQcwMe), (0)));
                                                /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B =
                                                //assign _5PIoPfFxk3a_3kbj9xa2zBf   
          /*add_int:*/ (( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B) + (1));
                                                        /*v_comp: */ _.v_0ZL8gaI6sH8_7UPhmAQcwMe =
                                                        //assign _9MDYXnUneZC_55Zuplll9EL   
          /*nodenthson:*/
          nodenthson_BM (( /*v_node: */ _.v_2BkOxf2KbS8_3bswrKbmgjy),
                         ( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B));
                                                        /*o_conn: */ _.o_13K9OfeXRZR_84nyRTtoj81 =
                                                        //assign _5AU8VvXYKZi_4SctVVKIMuJ   
          /*nodeconn:*/
          nodeconn_BM ( /*v_comp: */ _.v_0ZL8gaI6sH8_7UPhmAQcwMe);
...
/*endcond _74NGaPfSZlF_0iubWpQ8MfB*/
                                                        ...
                                                        //assign _7TkhikithqF_1AkAJAb7x0F  
      /*val_to_object:*/
      objectcast_BM ( /*nodenthson: */
                     nodenthson_BM (( /*v_node: */ _.
                                     v_2BkOxf2KbS8_3bswrKbmgjy),
...
//+ #10/18 of block _5SooyVqYKIT_4dQpCFeTVkV :: 
                                                ...
                                                /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B =
                                                //assign _8279WDUMSye_2IKLmTEWTnL  
      /*add_int:*/ (( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B) + (1));


                                                        /*v_countexp: */ _.v_4leeeoANgjm_31PbCGhynlU =
                                                        //assign _99PVif8XeCx_8hVkInmD6H8  
      /*nodenthson:*/
      nodenthson_BM (( /*v_node: */ _.v_2BkOxf2KbS8_3bswrKbmgjy),
                     ( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B));
...
//+ #12/18 of block _5SooyVqYKIT_4dQpCFeTVkV :: 
                                                ...
                                                /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B =
                                                //assign _0diYr9ji2Mr_3kb6QR3hxRC  
      /*add_int:*/ (( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B) + (1));
...
/*when _6bvk442PdYH_20YoMJsuair:*/
      ( /*is_null: */
      (( /*o_varindex: */ _.o_4QkDiZYXmJR_8VofvgKqcu4) == NULL))
      {                         //body when _6bvk442PdYH_20YoMJsuair  
...
/*syntax error no-varindex*/
          objparserrorprintf_BM ( /*o_parser: */ _.o_5fGGXIme43z_0mc4HIwzzMj,
                                 ...
                                 objectdbg_BM ( /*o_verb: */ _.
                                               o_3aIzfMKBbIH_2z7FHf3JclZ));;
...
/*when _2BybqU6CWcr_8Njufk4aC0o:*/
      ( /*is_null: */
      (( /*v_countexp: */ _.v_4leeeoANgjm_31PbCGhynlU) == NULL))
      {                         //body when _2BybqU6CWcr_8Njufk4aC0o  
...
//+ #16/18 of block _5SooyVqYKIT_4dQpCFeTVkV :: 
                                                ...
                                                /*i_start: */ _.n_4Dke6KoVx5r_1CoVhK8mVmc =
                                                //assign _6yN8IRiJKaB_0Ynq7PFj9TC  
      /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B;



    {                           // begin lockobj _9Om1a31BzaS_5TkPLp6j4lV 
      objectval_tyBM *curlockedob_9Om1a31BzaS_5TkPLp6j4lV =
        ( /*o_resobj: */ _.o_4jyHvEiEzZ1_9ck99ShNTHx);
      if (objlock_BM (curlockedob_9Om1a31BzaS_5TkPLp6j4lV))
        {
          locked_9Om1a31BzaS_5TkPLp6j4lV =
            curlockedob_9Om1a31BzaS_5TkPLp6j4lV;


          {                     // run _4AdqBDnuFGi_7lYJ3HxFm5x 
/*debug for_loop#readmacro v_node lineno colpos o_resobj*/
            DBGPRINTF_BM
              ("for_loop#readmacro €%.9s v_node=%s lineno#%ld colpos#%ld o_resobj=%s",
...
/*when _6Al3Bi72SRA_9nH9fFB9MUz:*/
            ...
            (!( /*objectisinstance: */
               objectisinstance_BM (( /*o_resobj: */ _.
                                     o_4jyHvEiEzZ1_9ck99ShNTHx),
                                    ( /*o_class: */ _.
                                     o_0yYNVlhznPw_115q5g6EYO0)))))
            {                   //body when _6Al3Bi72SRA_9nH9fFB9MUz  
...
// while _8kjbgwzFmjv_4jrW3mPyJAP comp#0:  
                                                        /*v_comp: */ _.v_0ZL8gaI6sH8_7UPhmAQcwMe =
                                                        //assign _06FkUnkHzVK_2RFUCedoKwa   
              /*nodenthson:*/
              nodenthson_BM (( /*v_node: */ _.v_2BkOxf2KbS8_3bswrKbmgjy),
                             ( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B));
...
/*debug for_loop#readmacro v_node o_resobj ii v_comp*/
              DBGPRINTF_BM
                ("for_loop#readmacro €%.9s v_node=%s o_resobj=%s ii#%ld v_comp=%s",
...
/*when _1JZf5yCHQQe_9EJfiGR7PgJ:*/
              ...
              {                 //body when _1JZf5yCHQQe_9EJfiGR7PgJ   
                {               // start cexpansion _72SahaxYkMv_43rvkWpzaWy - objappendcomp    
                  /*objappendcomp:*/
                    objappendcomp_BM (( /*o_resobj: */ _.
                                       o_4jyHvEiEzZ1_9ck99ShNTHx),
...
/*when _7hfwvOfsWF8_8i8a85HTGdB:*/
              ...
              {                 //body when _7hfwvOfsWF8_8i8a85HTGdB   
                {               // start cexpansion _6PQl0qnzf17_1MSNcVNLu73 - objappendcomp    
                  /*objappendcomp:*/
                    objappendcomp_BM (( /*o_resobj: */ _.
                                       o_4jyHvEiEzZ1_9ck99ShNTHx), (NULL));
...
/*syntaxerror lineno colpos o_verb bad v_comp ii v_node expecting object-stmt or nil*/
                  objparserrorprintf_BM ( /*o_parser: */ _.
                                         o_5fGGXIme43z_0mc4HIwzzMj,
                                         CURFRAME_BM,
                                         (unsigned) ( /*i_lineno: */ _.
                                                     n_6x2LYnlYgQG_6FXtmtwODgo),
                                         (unsigned) ( /*i_colpos: */ _.
                                                     n_2sygPI8PHgL_4RgFW0PkZbd),
...
// while _8kjbgwzFmjv_4jrW3mPyJAP comp#3:  
                                                        /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B =
                                                        //assign _70OHr2grpQb_0FNZSvGKd2q   
              /*add_int:*/ (( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B) + (1));
...
/*debug for_loop#readmacro end o_resobj*/
          ...
          objunlock_BM (locked_9Om1a31BzaS_5TkPLp6j4lV),
            locked_9Om1a31BzaS_5TkPLp6j4lV = NULL;
        }
...
epilog_8dG7KZHgf3t_4ia32mWZqVQ:__attribute__((unused));
                                // routine _8dG7KZHgf3t_4ia32mWZqVQ epilogue:
  // unlocking 1:
  ...
  if (stkf)
    stkf->stkfram_callfun = NULL;
  return /*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ;
}                               // end _8dG7KZHgf3t_4ia32mWZqVQ routine#19 _8dG7KZHgf3t_4ia32mWZqVQ




value_tyBM crout_8imWClcIFKt_6w2H2ouB4I6_BM     //#20+
...
{                               // start of iterate_sequence_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[30] /*|iterate_sequence_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
  ...
  const closure_tyBM *callclos_8imWClcIFKt_6w2H2ouB4I6
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
epilog_8imWClcIFKt_6w2H2ouB4I6:__attribute__((unused));
  ...
  if (stkf)
    stkf->stkfram_callfun = NULL;
  return /*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ;
}                               // end _8imWClcIFKt_6w2H2ouB4I6 routine#20 iterate_sequence_minifunc
...
{                               // start of _9CG8SKNs6Ql_4PiHd8cnydn
  ...
  _.stkfram_head.rlen = 2;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[33] /*|_9CG8SKNs6Ql_4PiHd8cnydn */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  const closure_tyBM *callclos_9CG8SKNs6Ql_4PiHd8cnydn
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
/*when _8QkV0tL7Jvt_9mc0QaZYbyv:*/
      ...
      {                         //body when _8QkV0tL7Jvt_9mc0QaZYbyv  
                                                                                        /*return _2RCw0JQb23v_2NfFku112jv:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*odict: */ _.o_7n2SLLuWOjH_4ArhFUjmckz;
...
/*when _8bCPs7gML9M_12nXMrdhzvW:*/
      ...
      {                         //body when _8bCPs7gML9M_12nXMrdhzvW  
                                                                                        /*return _9198YxnrBs6_7u9nhmAA8Q6:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*odict: */ _.o_7n2SLLuWOjH_4ArhFUjmckz;
        goto epilog_9CG8SKNs6Ql_4PiHd8cnydn;
...
// the constant ids for 35 constants:
const char *const constid_3BFt4NfJmZC_7iYi2dwM38B_BM[35 + 1] = {
  /*0: */
  ...
  /*20: */
  "_4qnxZdea4qp_3ghonuiHfNf",   //! dump_data°persistent_json_object<o_json (o_dumper o_strbuf)
...
#ifdef BISMON_MODID
value_tyBM moduleinit_3BFt4NfJmZC_7iYi2dwM38B_BM (struct stackframe_stBM *stkf, //
