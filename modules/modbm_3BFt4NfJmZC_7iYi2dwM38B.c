...
// declare 60 constants
objectval_tyBM *constob_3BFt4NfJmZC_7iYi2dwM38B_BM[60 + 1];
const char *const constid_3BFt4NfJmZC_7iYi2dwM38B_BM[60 + 1];
...
/*when _3674ULyT2hz_5gMJA95w9aB:*/
      ...
      {                         //body when _3674ULyT2hz_5gMJA95w9aB  
        ...
        {                       // run _2Gx3OIyj6WH_36HZRfp3Slv  
          (apply1_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[51]
...
{                               // start of element_of_closed_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[8] /*|element_of_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of _1HZc1VBbjdB_96aQTEPgEX0
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[13] /*|_1HZc1VBbjdB_96aQTEPgEX0 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
{                               // start of _22Zd68WPKUO_6AoIuBcbUb2
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[15] /*|_22Zd68WPKUO_6AoIuBcbUb2 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
{                               // start of _2bZ4BfCci5V_3WTzG7V25y4
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[17] /*|_2bZ4BfCci5V_3WTzG7V25y4 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
{                               // start of _3iiht57Wrs1_5NbiUi27oBn
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[20] /*|_3iiht57Wrs1_5NbiUi27oBn */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
{                               // start of _3vI0Qc3FHQG_1g4fmHYkxSA
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[21] /*|_3vI0Qc3FHQG_1g4fmHYkxSA */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // locking 4:
...
/*makeobj:*/ makeobj_BM ();
    ...
    {                           // start cexpansion _1LQNZfT8P4L_3LBZMwCIKGf - objputattr  
      ...
      objputattr_BM (( /*o_jsgenmod: */ _.o_4JKd986pvM4_6yBzeeI40vW),
                     ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[34] /*!sbuf */ )),
                     ( /*o_strbuf: */ _.o_41F1rKwGbaA_30OJWKsqNWy));
    ...
    {                           // start cexpansion _8owvpghf95c_70WEDPAsJGV - objputattr  
      /*objputattr: */
      objputattr_BM (( /*o_jsgenmod: */ _.o_4JKd986pvM4_6yBzeeI40vW),
                     ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[14] /*!for */ )),
                     ( /*o_jsmodule: */ _.o_5V0w37YnN4F_8dZ6I79V60O));
...
//failure _6pp3g7GLuae_7OF8KezKzvx    
                      PLACEDFAILURE_BM (__LINE__,
                                        ...
                                        ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM
                                          [40] /*|failure_non_object */ )),
                                        /*failplace: */
                                        (       /*modconst: */
                                          (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[39]       /*|_6pp3g7GLuae_7OF8KezKzvx */
                                          )),
                                        ((struct stackframe_stBM *) &_));
                          ...
                          (     /*not: */
                            (!( /*objectisinstance: */
                                objectisinstance_BM (( /*o_jscurcomp: */ _.
                                                      o_2TaoEvH5OQU_8nKYBgAvkmW),
                                                     ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[48] /*!jscript_toplevel_object */ ))))))
...
//failure _4jwFGdaECBb_6dsBLTMoG9j    
                            PLACEDFAILURE_BM (__LINE__,
                                              /*failreason: */ (((value_tyBM) makenode2_BM
                                                                 (
                                                                   /*make_node conn: */
                                                                   ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[30] /*!failure_bad_class */ )),
/*make_node 2 sons: */
                                                                   ( /*o_jscurcomp: */ _.o_2TaoEvH5OQU_8nKYBgAvkmW),
...
//failure _0Lk9WQfjqpU_0XROvsMVANm   
                                PLACEDFAILURE_BM (__LINE__,
                                                  ...
                                                  (((value_tyBM) makenode4_BM ( /*make_node conn: */
                                                                                ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[40] /*!failure_non_object */ )),
                                                                                /*make_node 4 sons: */
                                                                                ( /*v_resprep: */ _.
                                                                                 v_7nytuRkZkOz_8T9QMYQtGps),
                                                                                ( /*o_jscurcomp: */ _.
...
//failure _401XcQg0VWc_1SG4xaaQ3mU   
                    PLACEDFAILURE_BM (__LINE__,
                                      /*failreason: */ (((value_tyBM) makenode1_BM
                                                         (
                                                           /*make_node conn: */
                                                           ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[32] /*!emit_prologue_jsmodule */ )),
/*make_node 1 sons: */
                                                           (    /*o_jsgenmod: */
                                                             _.
                                                             o_4JKd986pvM4_6yBzeeI40vW)))),
...
//failure _4lj3ntdp7xH_5LiKY8h0lHl    
                            PLACEDFAILURE_BM (__LINE__,
                                              /*failreason: */ (((value_tyBM) makenode3_BM
                                                                 (
                                                                   /*make_node conn: */
                                                                   ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[50] /*!emit_jstoplevel */ )),
/*make_node 3 sons: */
                                                                   ( /*o_jscurcomp: */ _.o_2TaoEvH5OQU_8nKYBgAvkmW),
                                                                   ( /*taggedint: */ taggedint_BM ( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B)),
                                                                   ( /*o_jsgenmod: */ _.o_4JKd986pvM4_6yBzeeI40vW)))),
...
//failure _75mkz7wH3u3_0ZQRFajA44k   
                    PLACEDFAILURE_BM (__LINE__,
                                      /*failreason: */ (((value_tyBM) makenode1_BM
                                                         (
                                                           /*make_node conn: */
                                                           ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[56] /*!emit_epilogue_jsmodule */ )),
/*make_node 1 sons: */
                                                           (    /*o_jsgenmod: */
                                                             _.
                                                             o_4JKd986pvM4_6yBzeeI40vW)))),
...
{                               // start of same_as_closed_minifunc
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[22] /*|same_as_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of _3HAeZZQ0q7b_7qyDsekaz7Y
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[23] /*|_3HAeZZQ0q7b_7qyDsekaz7Y */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of _44Xro7p814I_406P69WFbq4
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[25] /*|_44Xro7p814I_406P69WFbq4 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
//failure _8Nb7qSIbE8N_7xJDtsS0rdb   
        PLACEDFAILURE_BM (__LINE__,
                          /*failreason: */ (((value_tyBM) makenode3_BM
                                             (  /*make_node conn: */
                                               ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[41] /*!is_null */ )),
                                               /*make_node 3 sons: */
                                               ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[35] /*!variable */ )),
                                               ( /*o_jscurcomp: */ _.
                                                o_2TaoEvH5OQU_8nKYBgAvkmW),
                                               ( /*o_jsgenmod: */ _.
                                                o_4JKd986pvM4_6yBzeeI40vW)))),
...
//failure _68ynNIWu3mp_1Th7hFVKtoO   
        PLACEDFAILURE_BM (__LINE__,
                          /*failreason: */ (((value_tyBM) makenode4_BM
                                             (  /*make_node conn: */
                                               ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[18] /*!duplicate */ )),
                                               /*make_node 4 sons: */
                                               ( /*o_variable: */ _.
                                                o_7safxUAyjq9_7LcGUlnwwD1),
                                               ( /*o_jscurcomp: */ _.
...
{                               // start of equal_to_closed_minifunc
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[26] /*|equal_to_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of _4qlegfkPzrC_17skUfJP7v8
  ...
  _.stkfram_head.rlen = 6;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[29] /*|_4qlegfkPzrC_17skUfJP7v8 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
startblock__3oMW0T4HlXx_8r7NLpyK1J8:__attribute__ ((unused));
  {                             /* +block _3oMW0T4HlXx_8r7NLpyK1J8 */
    ...
    {                           // run _40XgQGIUZQY_246JbHmppCN 
      (send3_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[52] /*|clear */ )),
                 /*sel: */
                 ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[12] /*|dump_value */ )),
                 ((struct stackframe_stBM *) &_),
...
// while _9gJT0jotyox_8JQNlJn3qh6 comp#2:  
      ...
      {                         // run _4BOu5jhqyAD_3HGfVAY5hFx  
        (send3_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[57] /*|put */ )),
                   /*sel: */
                   ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[12]     /*|dump_value */
                    )), ((struct stackframe_stBM *) &_),
                   ( /*osbuf: */ _.o_6opEz55NyNu_3JKpBgxLijw),
...
{                               // start of _4M7lr5cU6VD_5hxmeH3baBf
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[31] /*|_4M7lr5cU6VD_5hxmeH3baBf */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
{                               // start of _5j8LpQULt1p_9oeOaqmfYYr
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[33] /*|_5j8LpQULt1p_9oeOaqmfYYr */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
{                               // start of _74TaCoUa4dg_2bmUAanJYIJ
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[43] /*|_74TaCoUa4dg_2bmUAanJYIJ */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 4 arguments:
...
{                               // start of findobj_scan_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[49] /*|findobj_scan_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of iterate_sequence_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[51] /*|iterate_sequence_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
//!jsemit_expression°jsvar_object >o_jsexpr (o_strbuf o_jsgenmod o_jsgenfun o_paren)
   // 4 arguments
   const value_tyBM arg0,       // o_strbuf
   const value_tyBM arg1,       // o_jsgenmod
   const value_tyBM arg2,       // o_jsgenfun
   const value_tyBM arg3,       // o_paren
   const quasinode_tyBM * restargs_ __attribute__ ((unused)))
{                               // start of _8Kh2MKilKO4_5qPRBWX9W3a
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[53] /*|_8Kh2MKilKO4_5qPRBWX9W3a */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 4 arguments:
  _.o_41F1rKwGbaA_30OJWKsqNWy = objectcast_BM (arg0);   // o_strbuf
  _.o_4JKd986pvM4_6yBzeeI40vW = objectcast_BM (arg1);   // o_jsgenmod
  _.o_5Lg7fb6zE3H_6ijQo6GbPN4 = objectcast_BM (arg2);   // o_jsgenfun
  _.o_7N9BaY4jXQb_2V4VMnRwsGD = objectcast_BM (arg3);   // o_paren
  // fetched 4 arguments.
...
{                               // start of _8VtkXEUFfhk_5RxrpY6JHI6
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[55] /*|_8VtkXEUFfhk_5RxrpY6JHI6 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // locking 2:
...
//failure _5YZZHXQmxrc_3SVoZ26utAx   
                    PLACEDFAILURE_BM (__LINE__,
                                      /*failreason: */ (((value_tyBM) makenode1_BM
                                                         (
                                                           /*make_node conn: */
                                                           ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[45] /*!compile_to_javascript */ )),
/*make_node 1 sons: */
                                                           (    /*o_jsmodule: */
                                                             _.
                                                             o_5V0w37YnN4F_8dZ6I79V60O)))),
...
{                               // start of _9CG8SKNs6Ql_4PiHd8cnydn
  ...
  _.stkfram_head.rlen = 2;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[59] /*|_9CG8SKNs6Ql_4PiHd8cnydn */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
// the constant ids for 60 constants:
const char *const constid_3BFt4NfJmZC_7iYi2dwM38B_BM[60 + 1] = {
  /*0: */
