...
startblock__8prn9eFlYZD_6JJKKh2b8KW:
...
startblock__4ZE2MUVTcHt_4lWsA1elKmS:
        __attribute__((unused));
        {
...
startblock__3VVvcLyYqv8_9yci7GvqEEv:
        __attribute__((unused));
        {
...
epilog_0cUdonky1bM_4IVhwlVRBMk:
    __attribute__ ((unused)); // routine _0cUdonky1bM_4IVhwlVRBMk epilogue:
...
startblock__8Zow03fhyT0_8uAZxZPDM5k:
    __attribute__((unused));
    {
            ...
            if (objlock_BM (curlockedob_2JvEoBxMhy7_9DZyjgGfHlv))
                {
                    ...
                    (/*not:*/ (! (/*objectisinstance:*/ objectisinstance_BM(( /*o_resobj:*/_.o_4jyHvEiEzZ1_9ck99ShNTHx),( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[34] /*!basiclo_outstmt*/))))))   //body when _8g6tUrNeSaK_9pEbME2mJdL
                        {
                            {
                                // start cexpansion _8Zs5gF0Cjtl_8nrkFlDX8H6 - objputclass
                                /*objputclass:*/objputclass_BM(( /*o_resobj:*/_.o_4jyHvEiEzZ1_9ck99ShNTHx),( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[34] /*!basiclo_outstmt*/)));
...
epilog_0g1CBaxjMIB_7NZdyHUikLG:
    __attribute__ ((unused)); // routine _0g1CBaxjMIB_7NZdyHUikLG epilogue:
    // unlocking 1:
...
startblock__9xHQlk4snoU_6unWwGT6PcG:
    __attribute__((unused));
    {
        /* +block _9xHQlk4snoU_6unWwGT6PcG */
        /*v_node:*/_.v_2BkOxf2KbS8_3bswrKbmgjy = //assign _8ggHPTQI1iG_02hVE5KybEL
            /*objlisttonodepayl:*/ (value_tyBM) objlisttonodepayl_BM(( /*o1:*/_.o_97rnxb0KFqq_44veN75DG2E),( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[26] /*|node*/)));
...
epilog_0JktC4mAHCa_1KNr6uMIqIi:
    __attribute__ ((unused)); // routine _0JktC4mAHCa_1KNr6uMIqIi epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__84ATc5kpHjd_2wlYHZEUoeb:
    __attribute__((unused));
    {
        ...
        (/*issequence:*/issequence_BM( /*v_arg:*/_.v_4Q4WBLjAPTV_5WVLmhAvCJY))   //body when _3674ULyT2hz_5gMJA95w9aB
            {

                {
                    ...
                    (apply1_BM (( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[30] /*!iterate_sequence_minifunc*/)), ((struct stackframe_stBM*)&_),
...
epilog_0SinERsgdvQ_57dLCP63i9r:
    __attribute__ ((unused)); // routine _0SinERsgdvQ_57dLCP63i9r epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__7gnMvoTqaQY_3kAwj2rwZEM:
    __attribute__((unused));
    {
...
epilog_0YOXUe7rEJC_3jFMjOAQRs9:
    __attribute__ ((unused)); // routine _0YOXUe7rEJC_3jFMjOAQRs9 epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__9Bl7iL3Qmc1_6IRbnbmMUJq:
    __attribute__((unused));
    {
...
epilog_110awzb480c_0n4frovb2yV:
    __attribute__ ((unused)); // routine _110awzb480c_0n4frovb2yV epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__7csjYG7rNV4_68bJZT4W2BO:
    __attribute__((unused));
    {
...
epilog_22Zd68WPKUO_6AoIuBcbUb2:
    __attribute__ ((unused)); // routine _22Zd68WPKUO_6AoIuBcbUb2 epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__0VJTIqFfNXf_5chzuIlqcJP:
    __attribute__((unused));
    {
...
epilog_2bZ4BfCci5V_3WTzG7V25y4:
    __attribute__ ((unused)); // routine _2bZ4BfCci5V_3WTzG7V25y4 epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__3SCriDcyk4V_8JxBGUtl9lK:
    __attribute__((unused));
    {
...
epilog_2nl9zcaSUwe_8UBiMp1OuMk:
    __attribute__ ((unused)); // routine _2nl9zcaSUwe_8UBiMp1OuMk epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__9BLJq5DadtZ_6I89t7ioVRS:
    __attribute__((unused));
    {
...
epilog_3iiht57Wrs1_5NbiUi27oBn:
    __attribute__ ((unused)); // routine _3iiht57Wrs1_5NbiUi27oBn epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__8seRhfNtGTR_4rOgARd0hVM:
    __attribute__((unused));
    {
...
epilog_3yQlckX4DRh_4b9l9FBSSSL:
    __attribute__ ((unused)); // routine _3yQlckX4DRh_4b9l9FBSSSL epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__4wSCE1PqaMS_2XYzFgB0waZ:
    __attribute__((unused));
    {
...
epilog_3HAeZZQ0q7b_7qyDsekaz7Y:
    __attribute__ ((unused)); // routine _3HAeZZQ0q7b_7qyDsekaz7Y epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__60FKeHfNUo3_9OSN4Cqm8zI:
    __attribute__((unused));
    {
...
epilog_4iEFTEcHxeb_6lH464uFkTC:
    __attribute__ ((unused)); // routine _4iEFTEcHxeb_6lH464uFkTC epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
...
startblock__3oMW0T4HlXx_8r7NLpyK1J8:
    __attribute__((unused));
    {
...
//+ #4/9 of block _3oMW0T4HlXx_8r7NLpyK1J8 ::
...

        {
            ...
            (send3_BM (( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[31] /*|clear*/)), /*sel:*/( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[9] /*|dump_value*/)), ((struct stackframe_stBM*)&_),
...
// while _9gJT0jotyox_8JQNlJn3qh6 comp#2:

            {
                ...
                (send3_BM (( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[32] /*|put*/)), /*sel:*/( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[9] /*|dump_value*/)), ((struct stackframe_stBM*)&_),
                           ( /*osbuf:*/_.o_6opEz55NyNu_3JKpBgxLijw),  ( /*odumper:*/_.o_3cTC8W7d75H_1vteOyEoAao),
                           ( ((value_tyBM)0x3 /*!1*/))));
...
epilog_4qlegfkPzrC_17skUfJP7v8:
    __attribute__ ((unused)); // routine _4qlegfkPzrC_17skUfJP7v8 epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
 ...
 const quasinode_tyBM * restargs_ __attribute__((unused)))
{
    ...
    _.stkfram_head.hgc = 0;
    _.stkfram_head.rlen = 5;
    _.stkfram_descr = constob_3BFt4NfJmZC_7iYi2dwM38B_BM[20] /*|_4qnxZdea4qp_3ghonuiHfNf*/;
    ASSERT_BM (!stkf
               || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
               || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
    _.stkfram_prev = stkf;
    ...
    const closure_tyBM* callclos_4qnxZdea4qp_3ghonuiHfNf __attribute__((unused)) =
        (stkf&&stkf->stkfram_pA.htyp == typayl_StackFrame_BM)
        ? (closurecast_BM(stkf->stkfram_callfun)) : NULL;
    const unsigned nbclosed_4qnxZdea4qp_3ghonuiHfNf  __attribute__((unused)) = 0;
    // routine _4qnxZdea4qp_3ghonuiHfNf body:

startblock__9lbn8XYjnv9_50alo8Io3Lx:
    __attribute__((unused));
    {
...

        {
            ...
            DBGPRINTF_BM("start dump_data°persistent_json_object €%.9s o_json=%s o_dump=%s o_strbuf=%s",
...

        {
            ...
            /*out newline:*/ objstrbuffernewlinepayl_BM ( /*o_strbuf:*/_.o_41F1rKwGbaA_30OJWKsqNWy);
            /*out string:*/ objstrbufferappendcstrpayl_BM ( /*o_strbuf:*/_.o_41F1rKwGbaA_30OJWKsqNWy,  "!~ json (~");
            /*out newline:*/ objstrbuffernewlinepayl_BM ( /*o_strbuf:*/_.o_41F1rKwGbaA_30OJWKsqNWy);
...
epilog_4qnxZdea4qp_3ghonuiHfNf:
    __attribute__ ((unused)); // routine _4qnxZdea4qp_3ghonuiHfNf epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
 ...
 const quasinode_tyBM * restargs_ __attribute__((unused)))
{
    ...
    _.stkfram_head.hgc = 0;
    _.stkfram_head.rlen = 3;
    _.stkfram_descr = constob_3BFt4NfJmZC_7iYi2dwM38B_BM[21] /*|_4M7lr5cU6VD_5hxmeH3baBf*/;
    ASSERT_BM (!stkf
               || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
               || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
    _.stkfram_prev = stkf;
...
startblock__883QaWUOedh_9zmHk2A3RPm:
    __attribute__((unused));
    {
...
epilog_4M7lr5cU6VD_5hxmeH3baBf:
    __attribute__ ((unused)); // routine _4M7lr5cU6VD_5hxmeH3baBf epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
 ...
 const quasinode_tyBM * restargs_ __attribute__((unused)))
{
    ...
    _.stkfram_head.hgc = 0;
    _.stkfram_head.rlen = 5;
    _.stkfram_descr = constob_3BFt4NfJmZC_7iYi2dwM38B_BM[22] /*|_5j8LpQULt1p_9oeOaqmfYYr*/;
    ASSERT_BM (!stkf
               || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
               || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
    _.stkfram_prev = stkf;
...
startblock__9Hf4n8AnqR7_7ve3Bi3kWMV:
    __attribute__((unused));
    {
...
epilog_5j8LpQULt1p_9oeOaqmfYYr:
    __attribute__ ((unused)); // routine _5j8LpQULt1p_9oeOaqmfYYr epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
 ...
 const quasinode_tyBM * restargs_ __attribute__((unused)))
{
    ...
    _.stkfram_head.hgc = 0;
    _.stkfram_head.rlen = 5;
    _.stkfram_descr = constob_3BFt4NfJmZC_7iYi2dwM38B_BM[27] /*|_7MtjMTkmErH_2zSJ1YDKHVi*/;
    ASSERT_BM (!stkf
               || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
               || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
    _.stkfram_prev = stkf;
...
startblock__2CQSAWSZYj5_98YYbJMAfN2:
    __attribute__((unused));
    {
...
epilog_7MtjMTkmErH_2zSJ1YDKHVi:
    __attribute__ ((unused)); // routine _7MtjMTkmErH_2zSJ1YDKHVi epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
 ...
 const quasinode_tyBM * restargs_ __attribute__((unused)))
{
    ...
    _.stkfram_head.hgc = 0;
    _.stkfram_head.rlen = 4;
    _.stkfram_descr = constob_3BFt4NfJmZC_7iYi2dwM38B_BM[28] /*|findobj_scan_minifunc*/;
    ASSERT_BM (!stkf
               || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
               || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
    _.stkfram_prev = stkf;
...
startblock__6YnYKKsHo3f_9nIEOZMp744:
    __attribute__((unused));
    {
...

        {
            ...
            /*begin findobj_scan_minifunc*/ WEAKASSERT_BM(objectisinstance_BM ( /*o_findobj:*/_.o_4ITcQtvlMmO_30Pss9oAVDB,  (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[24] /*|findrun_object*/))); ;
...
epilog_82ho9wUUDji_4peMLha4PXl:
    __attribute__ ((unused)); // routine _82ho9wUUDji_4peMLha4PXl epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
 ...
 const quasinode_tyBM * restargs_ __attribute__((unused)))
{
    ...
    _.stkfram_descr = constob_3BFt4NfJmZC_7iYi2dwM38B_BM[29] /*|_8dG7KZHgf3t_4ia32mWZqVQ*/;
    ASSERT_BM (!stkf
               || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
               || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
    _.stkfram_prev = stkf;
...
startblock__5SooyVqYKIT_4dQpCFeTVkV:
    __attribute__((unused));
    {
...
//+ #4/11 of lockobj _9Om1a31BzaS_5TkPLp6j4lV ::
...

                    {
                        ...
                        /*objputattr:*/objputattr_BM(( /*o_resobj:*/_.o_4jyHvEiEzZ1_9ck99ShNTHx),( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[23] /*!count*/)),( /*v_countexp:*/_.v_4leeeoANgjm_31PbCGhynlU));
...
//+ #6/11 of lockobj _9Om1a31BzaS_5TkPLp6j4lV ::
                    {
                        ...
                        /*objputattr:*/objputattr_BM(( /*o_resobj:*/_.o_4jyHvEiEzZ1_9ck99ShNTHx),( (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[25] /*!index*/)),( /*o_varindex:*/_.o_4QkDiZYXmJR_8VofvgKqcu4));
...
epilog_8dG7KZHgf3t_4ia32mWZqVQ:
    __attribute__ ((unused)); // routine _8dG7KZHgf3t_4ia32mWZqVQ epilogue:
    // unlocking 1:
 ...
 const quasinode_tyBM * restargs_ __attribute__((unused)))
{
    ...
    _.stkfram_head.hgc = 0;
    _.stkfram_head.rlen = 4;
    _.stkfram_descr = constob_3BFt4NfJmZC_7iYi2dwM38B_BM[30] /*|iterate_sequence_minifunc*/;
    ASSERT_BM (!stkf
               || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
               || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
    _.stkfram_prev = stkf;
...
startblock__2W6NObLb2d4_6OfkP3dYlF3:
    __attribute__((unused));
    {
...
startblock__3vvVJBONOyK_3kn86nuYwr1:
        __attribute__((unused));
        {
            /* +loop _3vvVJBONOyK_3kn86nuYwr1 */
startloop__3vvVJBONOyK_3kn86nuYwr1:
            __attribute__((unused));
...
endblock__3vvVJBONOyK_3kn86nuYwr1:
            __attribute__((unused));
        } /*-loop _3vvVJBONOyK_3kn86nuYwr1 */
...
epilog_8imWClcIFKt_6w2H2ouB4I6:
    __attribute__ ((unused)); // routine _8imWClcIFKt_6w2H2ouB4I6 epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
 ...
 const quasinode_tyBM * restargs_ __attribute__((unused)))
{
    ...
    _.stkfram_head.hgc = 0;
    _.stkfram_head.rlen = 2;
    _.stkfram_descr = constob_3BFt4NfJmZC_7iYi2dwM38B_BM[33] /*|_9CG8SKNs6Ql_4PiHd8cnydn*/;
    ASSERT_BM (!stkf
               || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
               || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
    _.stkfram_prev = stkf;
...
startblock__1lmLI285f7p_4im4Ls4Xewh:
    __attribute__((unused));
    {
...
epilog_9CG8SKNs6Ql_4PiHd8cnydn:
    __attribute__ ((unused)); // routine _9CG8SKNs6Ql_4PiHd8cnydn epilogue:
    if (stkf) stkf->stkfram_callfun = NULL;
    return  /*v_r:*/_.v_3qw9bnATIhq_8loBraLeXzQ;
 ...
 void* dlh)
{
    LOCALFRAME_BM(/*prev:*/stkf,
                           ...
                           INFOPRINTF_BM("§initializing simple module _3BFt4NfJmZC_7iYi2dwM38B with arguments (%s, %s, %s); module counter 1",
