...
extern objrout_sigBM crout_1HZc1VBbjdB_96aQTEPgEX0_BM;  //#4 !emit_prologue_jsmodule°jsmodule_generation_object
...
extern objrout_sigBM crout_3vI0Qc3FHQG_1g4fmHYkxSA_BM;  //#8 !compile_to_javascript°jsmodule_object (o_jsmodule, o_strbuf)
...
{                               // start of _0JktC4mAHCa_1KNr6uMIqIi
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[2] /*|_0JktC4mAHCa_1KNr6uMIqIi */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
/*when _3674ULyT2hz_5gMJA95w9aB:*/
      ...
      {                         //body when _3674ULyT2hz_5gMJA95w9aB  
        ...
        {                       // run _2Gx3OIyj6WH_36HZRfp3Slv  
          (apply1_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[40]
...
{                               // start of element_of_closed_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[5] /*|element_of_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
value_tyBM crout_1HZc1VBbjdB_96aQTEPgEX0_BM     //#4
  (struct stackframe_stBM * stkf,       //
...
{                               // start of _1HZc1VBbjdB_96aQTEPgEX0
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[10] /*|_1HZc1VBbjdB_96aQTEPgEX0 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
/*makeobj:*/ makeobj_BM ();
    ...
    {                           // start cexpansion _7Uill32vOpW_9wlNaomdHOF - objputattr  
      /*objputattr: */
      objputattr_BM (( /*o_bindings: */ _.o_5HkpTupRRIK_8iCooVukjb3),
    ...
    {                           // run _0ACW8XdRvUP_5WPy2xnm92L 
      /*objputassocpayl: */ objputassocpayl_BM ( /*o_bindings: */ _.
                                                ...
                                                ((5) +
                                                 ( /*objnbcomps: */
                                                  objnbcomps_BM ( /*o_jsgenmod: */ _.o_4JKd986pvM4_6yBzeeI40vW))));
...
epilog_1HZc1VBbjdB_96aQTEPgEX0:__attribute__ ((unused));
  ...
  if (stkf)
    stkf->stkfram_callfun = NULL;
  return /*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ;
}                               // end _1HZc1VBbjdB_96aQTEPgEX0 routine#4 _1HZc1VBbjdB_96aQTEPgEX0
...
{                               // start of _22Zd68WPKUO_6AoIuBcbUb2
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[12] /*|_22Zd68WPKUO_6AoIuBcbUb2 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
{                               // start of _2bZ4BfCci5V_3WTzG7V25y4
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[13] /*|_2bZ4BfCci5V_3WTzG7V25y4 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
{                               // start of _3iiht57Wrs1_5NbiUi27oBn
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[14] /*|_3iiht57Wrs1_5NbiUi27oBn */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
value_tyBM crout_3vI0Qc3FHQG_1g4fmHYkxSA_BM     //#8
  (struct stackframe_stBM * stkf,       //
...
{                               // start of _3vI0Qc3FHQG_1g4fmHYkxSA
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[15] /*|_3vI0Qc3FHQG_1g4fmHYkxSA */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // locking 4:
...
/*makeobj:*/ makeobj_BM ();
    ...
    {                           // start cexpansion _1LQNZfT8P4L_3LBZMwCIKGf - objputattr  
      ...
      objputattr_BM (( /*o_jsgenmod: */ _.o_4JKd986pvM4_6yBzeeI40vW),
                     ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[27] /*!sbuf */ )),
...
//failure _6pp3g7GLuae_7OF8KezKzvx    
                      PLACEDFAILURE_BM (__LINE__,       /*failreason: */
                                        ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM
                                          [31] /*|failure_non_object */ )),
                                        /*failplace: */
                                        (       /*modconst: */
                                          (constob_3BFt4NfJmZC_7iYi2dwM38B_BM[30]       /*|_6pp3g7GLuae_7OF8KezKzvx */
                                          )),
                                        ((struct stackframe_stBM *) &_));
                          ...
                          (     /*not: */
                            (!( /*objectisinstance: */
                                objectisinstance_BM (( /*o_jscurcomp: */ _.
                                                      o_2TaoEvH5OQU_8nKYBgAvkmW),
                                                     ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[37] /*!jscript_toplevel_object */ ))))))
...
//failure _0Lk9WQfjqpU_0XROvsMVANm   
                                PLACEDFAILURE_BM (__LINE__,     /*failreason: */
                                                  (((value_tyBM) makenode3_BM (
                                                                                /*make_node conn: */
                                                                                ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[31] /*!failure_non_object */ )),
/*make_node 3 sons: */
                                                                                ( /*v_resprep: */ _.v_7nytuRkZkOz_8T9QMYQtGps),
                                                                                ( /*o_jscurcomp: */ _.o_2TaoEvH5OQU_8nKYBgAvkmW),
                                                                                ( /*taggedint: */ taggedint_BM ( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B))))),
...
//failure _401XcQg0VWc_1SG4xaaQ3mU   
                    PLACEDFAILURE_BM (__LINE__, /*failreason: */
                                      (((value_tyBM) makenode1_BM (
                                                                    /*make_node conn: */
                                                                    ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[25]    /*!emit_prologue_jsmodule */
                                                                     )),
/*make_node 1 sons: */
                                                                    ( /*o_jsgenmod: */ _.o_4JKd986pvM4_6yBzeeI40vW)))),
                                      /*failplace: */
...
//failure _4lj3ntdp7xH_5LiKY8h0lHl    
                            PLACEDFAILURE_BM (__LINE__, /*failreason: */
                                              (((value_tyBM) makenode3_BM (
                                                                            /*make_node conn: */
                                                                            ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[39] /*!emit_jstoplevel */ )),
/*make_node 3 sons: */
                                                                            ( /*o_jscurcomp: */ _.o_2TaoEvH5OQU_8nKYBgAvkmW),
                                                                            ( /*taggedint: */ taggedint_BM ( /*ii: */ _.n_2W7Ckt2WxEM_4NVYgEWE73B)),
                                                                            ( /*o_jsgenmod: */ _.o_4JKd986pvM4_6yBzeeI40vW)))),
...
//failure _75mkz7wH3u3_0ZQRFajA44k   
                    PLACEDFAILURE_BM (__LINE__, /*failreason: */
                                      (((value_tyBM) makenode1_BM (
                                                                    /*make_node conn: */
                                                                    ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[43]    /*!emit_epilogue_jsmodule */
                                                                     )),
/*make_node 1 sons: */
                                                                    ( /*o_jsgenmod: */ _.o_4JKd986pvM4_6yBzeeI40vW)))),
                                      /*failplace: */
...
epilog_3vI0Qc3FHQG_1g4fmHYkxSA:__attribute__ ((unused));
  ...
  if (stkf)
    stkf->stkfram_callfun = NULL;
  return /*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ;
}                               // end _3vI0Qc3FHQG_1g4fmHYkxSA routine#8 _3vI0Qc3FHQG_1g4fmHYkxSA
...
{                               // start of same_as_closed_minifunc
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[16] /*|same_as_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of _3HAeZZQ0q7b_7qyDsekaz7Y
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[17] /*|_3HAeZZQ0q7b_7qyDsekaz7Y */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of equal_to_closed_minifunc
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[19] /*|equal_to_closed_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of _4qlegfkPzrC_17skUfJP7v8
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[22] /*|_4qlegfkPzrC_17skUfJP7v8 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
startblock__3oMW0T4HlXx_8r7NLpyK1J8:__attribute__ ((unused));
  {                             /* +block _3oMW0T4HlXx_8r7NLpyK1J8 */
    ...
    {                           // run _40XgQGIUZQY_246JbHmppCN 
      (send3_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[41] /*|clear */ )),
                 /*sel: */ 
...
// while _9gJT0jotyox_8JQNlJn3qh6 comp#2:  
      ...
      {                         // run _4BOu5jhqyAD_3HGfVAY5hFx  
        (send3_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[44] /*|put */ )),
                   /*sel: */
                   ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[9] /*|dump_value */
                     )), ((struct stackframe_stBM *) &_),
                   ( /*osbuf: */ _.o_6opEz55NyNu_3JKpBgxLijw),
...
{                               // start of _4M7lr5cU6VD_5hxmeH3baBf
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[24] /*|_4M7lr5cU6VD_5hxmeH3baBf */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
{                               // start of _5j8LpQULt1p_9oeOaqmfYYr
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[26] /*|_5j8LpQULt1p_9oeOaqmfYYr */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
{                               // start of findobj_scan_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[38] /*|findobj_scan_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of iterate_sequence_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[40] /*|iterate_sequence_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
{                               // start of _8VtkXEUFfhk_5RxrpY6JHI6
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[42] /*|_8VtkXEUFfhk_5RxrpY6JHI6 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // locking 2:
...
//failure _5YZZHXQmxrc_3SVoZ26utAx   
                    PLACEDFAILURE_BM (__LINE__, /*failreason: */
                                      (((value_tyBM) makenode1_BM (
                                                                    /*make_node conn: */
                                                                    ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[34] /*!compile_to_javascript */ )),
/*make_node 1 sons: */
                                                                    ( /*o_jsmodule: */ _.o_5V0w37YnN4F_8dZ6I79V60O)))),
                                      /*failplace: */
                                      ( /*modconst: */
...
{                               // start of _9CG8SKNs6Ql_4PiHd8cnydn
  ...
  _.stkfram_head.rlen = 2;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[46] /*|_9CG8SKNs6Ql_4PiHd8cnydn */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
