...
/*val_to_object:*/ objectcast_BM (_.v_4Q4WBLjAPTV_5WVLmhAvCJY);
      ...
      ( /*issequence: */ issequence_BM (_.v_4Q4WBLjAPTV_5WVLmhAvCJY))
      {
        ...
        {                       // run _2Gx3OIyj6WH_36HZRfp3Slv  
          (apply1_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[22]
...
{                               // start of _22Zd68WPKUO_6AoIuBcbUb2
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[8] /*|_22Zd68WPKUO_6AoIuBcbUb2 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
{                               // start of _4qlegfkPzrC_17skUfJP7v8
  ...
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[15] /*|_4qlegfkPzrC_17skUfJP7v8 */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
/*objstrbuffersetindentpayl:*/
    ...
    {                           // run _40XgQGIUZQY_246JbHmppCN 
      (send3_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[23] /*|clear */ )),
                 /*sel: */
...
// while _9gJT0jotyox_8JQNlJn3qh6 comp#2:  
      ...
      {                         // run _4BOu5jhqyAD_3HGfVAY5hFx  
        (send3_BM (((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[24] /*|put */ )),
                   /*sel: */
                   ((constob_3BFt4NfJmZC_7iYi2dwM38B_BM[6]      /*|dump_value */
                    )), ((struct stackframe_stBM *) &_),
...
{                               // start of _4M7lr5cU6VD_5hxmeH3baBf
  ...
  _.stkfram_head.rlen = 3;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[16] /*|_4M7lr5cU6VD_5hxmeH3baBf */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
...
{                               // start of _5j8LpQULt1p_9oeOaqmfYYr
  ...
  _.stkfram_head.rlen = 5;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[17] /*|_5j8LpQULt1p_9oeOaqmfYYr */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
{                               // start of findobj_scan_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[21] /*|findobj_scan_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
...
{                               // start of iterate_sequence_minifunc
  ...
  _.stkfram_head.rlen = 4;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[22] /*|iterate_sequence_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 3 arguments:
...
{                               // start of _9CG8SKNs6Ql_4PiHd8cnydn
  ...
  _.stkfram_head.rlen = 2;
  _.stkfram_descr =
    constob_3BFt4NfJmZC_7iYi2dwM38B_BM[26] /*|_9CG8SKNs6Ql_4PiHd8cnydn */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
