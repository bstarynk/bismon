...
{                               // start of init_chariotdemo
  ...
  _.stkfram_descr =
    constob_55roYj6pggy_95lbHks0q2X_BM[0] /*|init_chariotdemo */ ;
  ...
  const closure_tyBM *callclos_0oA6AajbKuk_8rDrkR7F4jZ
...
/*inform init_chariotdemo start*/
      ...
      INFOPRINTF_BM ("initchariot_demo starting €%.8s...",
                     "_38RZobUaaQ3_2WZL2X2Cmx3");
      ;
...
epilog_0oA6AajbKuk_8rDrkR7F4jZ:__attribute__((unused));
                                // routine _0oA6AajbKuk_8rDrkR7F4jZ epilogue:
  if (stkf)
...
{                               // start of _5603DuLsw8z_4ztK4e4aYMp
  ...
  _.stkfram_descr =
    constob_55roYj6pggy_95lbHks0q2X_BM[2] /*|_5603DuLsw8z_4ztK4e4aYMp */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 2 arguments:
  ...
  const closure_tyBM *callclos_5603DuLsw8z_4ztK4e4aYMp
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
/*debug  restchariot2q19-httphandler start v_restpath o_webex*/
      DBGPRINTF_BM
        ("restchariot2q19-httphandler start €%.9s v_restpath=%s o_webex=%s",
...
/*when _3ia9CB9OTLD_7qmCT1GJ3Ni:*/
        ( /*has_string: */
         hasstring_BM (( /*v_restpath: */ _.v_6QhNRfe1Cte_0niVlWfAlmO),
                       ("/startchariot")))
        {                       //body when _3ia9CB9OTLD_7qmCT1GJ3Ni   

          {                     // run _4K7kSR4Ut7B_6fF7sSUy1m0   
/*debug when /startchariot o_webex /:restchariot2q19-httphandler*/
            DBGPRINTF_BM
              ("when /startchariot €%.9s o_webex=%s /:restchariot2q19-httphandler",
...
/*debug restchariot2q19-httphandler ending v_restpath o_webex*/
      DBGPRINTF_BM
        ("debug restchariot2q19-httphandler ending €%.9s v_restpath=%s o_webex=%s (L%u, lin=%u, col=%u, last'%s')***\n%s\n***\n",
         "_2j4uW6uN7uf_8DOo7iGaCMr",
         OUTSTRVALUE_BM ( /*v_restpath: */ _.v_6QhNRfe1Cte_0niVlWfAlmO),
         objectdbg_BM ( /*o_webex: */ _.o_5JuT4FgNFFh_7McrTYeT3jx),
         objstrbufferlengthpayl_BM ( /*o_webex: */ _.
                                    o_5JuT4FgNFFh_7McrTYeT3jx),
         objstrbufferlinecountpayl_BM ( /*o_webex: */ _.
                                       o_5JuT4FgNFFh_7McrTYeT3jx),
         objstrbuffercolumnpayl_BM ( /*o_webex: */ _.
                                    o_5JuT4FgNFFh_7McrTYeT3jx),
         objstrbuffercurrentlastlinepayl_BM ( /*o_webex: */ _.
                                             o_5JuT4FgNFFh_7McrTYeT3jx),
...
/*when _4fh1339mQXL_1tYitrVTLhj:*/
      ( /*objstrbufferlengthpayl */ (intptr_t)
       objstrbufferlengthpayl_BM (( /*o_webex: */ _.
                                   o_5JuT4FgNFFh_7McrTYeT3jx)))
      {                         //body when _4fh1339mQXL_1tYitrVTLhj  
...
/*warn o_webex failure /restchariot2q19-httphandler*/
          WARNPRINTF_BM
            ("restchariot2q19-httphandler failing €%.9s v_restpath=%s o_webex=%s '%s'",
          ...
          DBGBACKTRACEPRINTF_BM
            ("restchariot2q19-httphandler failing €%.9s v_restpath=%s o_webex=%s",
             "_0E4GHlCR1Ls_96gFoyMzQuS",
             OUTSTRVALUE_BM ( /*v_restpath: */ _.v_6QhNRfe1Cte_0niVlWfAlmO),
             objectdbg_BM ( /*o_webex: */ _.o_5JuT4FgNFFh_7McrTYeT3jx));
          ;
...
/*¤¤objwebexchangecompletepayl:*/
          ...
          objwebexchangecompletepayl_BM (( /*o_webex: */ _.
                                          o_5JuT4FgNFFh_7McrTYeT3jx),
                                         ( /*chunk-constob HTTP_NOT_FOUND: */
                                         (HTTP_NOT_FOUND)), ("text/plain"
#else /*no BISMON_LIBONION */
          FATAL_BM /*obsolete ¤¤objwebexchangecompletepayl */
          ("obsolete objwebexchangecompletepayl");
#endif /*BISMON_LIBONION */
...
/*endcond _13zkrw8w8YT_3erup1bBeRM*/
                                                                                ...
                                                                                /*return _5JZqcb5njTR_3TUFY6Ss0QU:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                // returned 
      /*o_webex: */ _.o_5JuT4FgNFFh_7McrTYeT3jx;
...
epilog_5603DuLsw8z_4ztK4e4aYMp:__attribute__((unused));
                                // routine _5603DuLsw8z_4ztK4e4aYMp epilogue:
  if (stkf)
    stkf->stkfram_callfun = NULL;
  return /*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ;
...
#ifdef BISMON_MODID
value_tyBM moduleinit_55roYj6pggy_95lbHks0q2X_BM (struct stackframe_stBM *stkf, //
