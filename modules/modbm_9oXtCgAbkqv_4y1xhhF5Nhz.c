...
{                               // start of _0qxuQEfimtp_1Wp2YuKHsJ3
  ...
  _.stkfram_descr =
    constob_9oXtCgAbkqv_4y1xhhF5Nhz_BM[0] /*|_0qxuQEfimtp_1Wp2YuKHsJ3 */ ;
  ...
  const closure_tyBM *callclos_0qxuQEfimtp_1Wp2YuKHsJ3
...
//!objswitch! test objswitch o1 . 
      objectval_tyBM *objswexp_411NjvTH7B8_3FGcvfkrAZJ =
        ( /*o1: */ _.o_97rnxb0KFqq_44veN75DG2E);
      switch (objecthash_BM (objswexp_411NjvTH7B8_3FGcvfkrAZJ) % 16)
        {
        case 2:
          if (objswexp_411NjvTH7B8_3FGcvfkrAZJ ==
              (constob_9oXtCgAbkqv_4y1xhhF5Nhz_BM[5] /*|hexa */ ))
            goto whenobj411NjvTH__8fWwRu3PMxA_6HlILozsTHd;
          goto defobj_411NjvTH7B8_3FGcvfkrAZJ;
        case 11:
          if (objswexp_411NjvTH7B8_3FGcvfkrAZJ ==
              (constob_9oXtCgAbkqv_4y1xhhF5Nhz_BM[4] /*|object */ ))
            goto whenobj411NjvTH__4BAGBRTZl7S_0xvgsAotvsa;
          goto defobj_411NjvTH7B8_3FGcvfkrAZJ;
        case 14:
          if (objswexp_411NjvTH7B8_3FGcvfkrAZJ ==
...
// objswitch _411NjvTH7B8_3FGcvfkrAZJ with 2 whens:  
        ...
        whenobj411NjvTH__4BAGBRTZl7S_0xvgsAotvsa:;
                                // when #0 of objswitch _411NjvTH7B8_3FGcvfkrAZJ  
...
/*debug object value case*/
        ...
        whenobj411NjvTH__8fWwRu3PMxA_6HlILozsTHd:;
                                // when #1 of objswitch _411NjvTH7B8_3FGcvfkrAZJ  
...
epilog_0qxuQEfimtp_1Wp2YuKHsJ3:__attribute__((unused));
                                // routine _0qxuQEfimtp_1Wp2YuKHsJ3 epilogue:
  if (stkf)
...
{                               // start of successor_test_minifunc
  ...
  _.stkfram_head.rlen = 2;
  _.stkfram_descr =
    constob_9oXtCgAbkqv_4y1xhhF5Nhz_BM[2] /*|successor_test_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  const closure_tyBM *callclos_43Y25VLmh6s_3JRpERevcR4
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
/*when _5mfKaUSS5M3_7TkY2bYFtdL:*/
      ...
      {                         //body when _5mfKaUSS5M3_7TkY2bYFtdL  
          ...
          /* val_to_int */ getint_BM ( /*v_i: */ _.v_3vRFuniDv1K_4bQ7DeekM2I);
                                                                                        /*return _860kWTaFg9p_8Jhm1G5uvqC:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          /*taggedint:*/
...
{                               // start of second_test_minifunc
  ...
  _.stkfram_head.rlen = 2;
  _.stkfram_descr =
    constob_9oXtCgAbkqv_4y1xhhF5Nhz_BM[7] /*|second_test_minifunc */ ;
  ASSERT_BM (!stkf || stkf->stkfram_pA.htyp == typayl_StackFrame_BM
             || stkf->stkfram_pA.htyp == typayl_SpecialFrame_BM);
  _.stkfram_prev = stkf;
  // fetch 1 arguments:
  ...
  const closure_tyBM *callclos_9O2lgu1TweO_0mVlpTwrBG1
    __attribute__((unused)) = (stkf
                               && stkf->stkfram_pA.htyp ==
                               typayl_StackFrame_BM) ? (closurecast_BM (stkf->
                                                                        stkfram_callfun))
...
/*when _2rCc2usyvqv_1TUCxOmrdFs:*/
      ...
      {                         //body when _2rCc2usyvqv_1TUCxOmrdFs  
                                                                                        /*return _3g94RQiswhV_2O5raZogJao:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          (constob_9oXtCgAbkqv_4y1xhhF5Nhz_BM[1] /*!int */ );
...
/*when _8ICBYlvMuJw_9rv1czcQPGI:*/
      ...
      {                         //body when _8ICBYlvMuJw_9rv1czcQPGI  
                                                                                        /*return _4NQMyG7YDk8_44PdNNG87Sr:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned  
          (constob_9oXtCgAbkqv_4y1xhhF5Nhz_BM[4] /*!object */ );
        goto epilog_9O2lgu1TweO_0mVlpTwrBG1;
      ...
      {                         /*cond else _1rIoTXPOfGY_2AFqgfS5G7T */
                                                                                        /*return _6NBwHeONub1_23PSzwWuTsb:*//*v_r: */ _.v_3qw9bnATIhq_8loBraLeXzQ =
                                                                                        // returned 
          (constob_9oXtCgAbkqv_4y1xhhF5Nhz_BM[3] /*!value */ );
        goto epilog_9O2lgu1TweO_0mVlpTwrBG1;
      }                         /*cond else _1rIoTXPOfGY_2AFqgfS5G7T */
...
epilog_9O2lgu1TweO_0mVlpTwrBG1:__attribute__((unused));
...
#ifdef BISMON_MODID
value_tyBM moduleinit_9oXtCgAbkqv_4y1xhhF5Nhz_BM (struct stackframe_stBM *stkf, //
