...
\item class information {\relsize{-1}{(vector of superclasses, dictionnary of methods, ...)}}
\item etc ...
\end{itemize}

So objects are very versatile {\relsize{-1}{(similar to those of \textsc{Eurisko} or
