...
\begin{frame}
    ...
    \begin{itemize}
     ...
     \item {\textcolor{red}{\textbf{difficult to debug and test}}} (\href{https://en.wikipedia.org/wiki/Heisenbug}{Heisenbugs})
       ...
       %%@@@@@
%-     \item wanting {\textcolor{red}{\textbf{metaprogramming}} {\relsize{-1}{(the code of GC support routines should be generated)}}
%-
...
%
%     \item multi-thread ``friendly'': stop the world variety.
%       
...
%         \item the write-barrier has to be implemented by changing the metaprogram (i.e. our C code generator)
%           \item \texttt{dlclose}-ing generated plugins is still science-fiction but should be done for garbage collection of generated code.
%
%     \end{itemize}
% \end{frame}
