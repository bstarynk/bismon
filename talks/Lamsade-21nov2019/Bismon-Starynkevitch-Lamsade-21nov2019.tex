...
%!\end{alltt}
%! :doc #{The \$FOREACH\_PAIR\_COMPONENT\_IN\_LIST iterator goes within a list, given by
%!he start formal \$LIS. Local formals are \$CURPAIR, bound to the
%!urrent pair, and \$CURCOMP, bound to the current component within the
%!ist.}#
%!  #{/* start foreach\_pair\_component\_in\_list \$EACHLIST */
...
%!       \$CURCOMP = melt\_pair\_head((melt\_ptr\_t) \$CURPAIR); }#
%!  #{ } /* end foreach\_pair\_component\_in\_list \$EACHLIST */
%!    \$CURPAIR = NULL;
%!    \$CURCOMP = NULL;
%!  }#
%! )
